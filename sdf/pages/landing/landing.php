...
<div id='' ng-controller='c_landing' class='bodyBG'>
	<div class='container  ' style='z-index:29;'>
		...
		<div class='row pm0 csr_ptr' ng-click='toCategories()' style="background-color:LIGHTgray">
			<span class='text-center'><h1 style='font-family: Delicious;'>EXPLORE</h1></span>
		</div>
				...
				<tr ng-repeat="kd in kurti_display" class='col-xs-6  ' style='padding:20px;'>
					<div style='width:100%;' class=''>
						<td class=' text-center emphasize  ' ng-click='detailed_prod(kd.id_kurti)' style='width:100%;cursor:pointer;background-color:white;border-radius:10px;'>
							<div class='' style='width:100%;border:1px solid gray;border-radius:0px;box-shadow: 1px 1px 1px #888888;'>
								<img style='width:100%;height:330px;border-radius:0px;' class='' ng-src='./sdf/images/products/kurtis/{{kd.id_kurti}}/1/{{kd.colors[0]}}/md/1.jpg'
								 alt='' />
